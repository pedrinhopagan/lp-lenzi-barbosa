...
import { Scale, Briefcase, Users, Lightbulb, Heart, Globe, Star, Home } from 'lucide-react'
import {
  Accordion,
  AccordionContent,
  AccordionItem,
...
export function Services() {
  const areasAtuacao = [
    ...
    { icon: Users, title: "Direito de Família", description: "Acompanhamento em processos de divórcio, guarda, pensão alimentícia e adoção." },
    { icon: Lightbulb, title: "Direito Empresarial", description: "Auxílio a empresas com planejamento jurídico, contratos e questões societárias." },
    { icon: Heart, title: "Direito Previdenciário", description: "Orientação e defesa em questões relacionadas à aposentadoria e benefícios do INSS." },
    { icon: Home, title: "Direito Imobiliário", description: "Assessoria em compra, venda e locação de imóveis, regularização e disputas de propriedade." }
  ]

  const diferenciais = [
    { icon: Globe, title: "Atendimento à Distância", description: "Consultoria e acompanhamento jurídico remoto para sua comodidade." },
    { icon: Star, title: "Experiência Especializada", description: "Profissionais com vasta experiência em casos complexos e abordagem humanizada." },
    { icon: Users, title: "Atendimento Personalizado", description: "Soluções jurídicas adaptadas às necessidades específicas de cada cliente." }
  ]
    ...
    <Container className="py-24 bg-gradient-to-b from-zinc-100 to-zinc-50">
      <div className="max-w-6xl mx-auto">
        ...
        <p className="text-blue-600 text-center mb-12">
          No escritório Lenzi e Barbosa, oferecemos soluções jurídicas personalizadas e eficientes, com atendimento especializado e de confiança.
        </p>

        <div className="flex flex-col md:flex-row gap-16">
          <div className="md:w-1/2">
            <h3 className="text-2xl font-bold mb-6 text-blue-700">Nossos Diferenciais</h3>
              ...
              {diferenciais.map((diferencial, index) => (
                ...
                >
                  <div className="flex items-center mb-3">
                    ...
                    <h4 className="text-xl font-bold text-blue-700">{diferencial.title}</h4>
                  </div>
        ...
        <p className="text-blue-500 text-center mt-8">
          Atendimento personalizado e eficiente, adaptado às suas necessidades, onde quer que você esteja.
        </p>
      </div>
    </Container>
  )
